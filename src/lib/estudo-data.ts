...
export const ATIVIDADE_CONFIG: Record<AtividadeTipo, { label: string; icone: LucideIcon; cor: string; corDot: string }> = {
  estudo:        { label: "Estudo de Matéria",    icone: BookOpen,    cor: "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300",       corDot: "bg-blue-500"    },
  questoes:      { label: "Questões",              icone: HelpCircle,  cor: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300", corDot: "bg-purple-500"  },
  recall:        { label: "Recall",                icone: RotateCcw,   cor: "bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300",     corDot: "bg-amber-500"   },
  caderno_erros: { label: "Caderno de Erros",      icone: NotebookPen, cor: "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300",            corDot: "bg-red-500"     },
  bateria:       { label: "Bateria de Questões",   icone: ListChecks,  cor: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300", corDot: "bg-emerald-500" },
};
...
export const MATERIAS: MateriaDef[] = [
  {
    ...
    corBadge: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300",
  ...
  },
  {
    ...
    corBadge: "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-sky-100 text-sky-700 dark:bg-sky-900 dark:text-sky-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-rose-100 text-rose-700 dark:bg-rose-900 dark:text-rose-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300",
    incluirDefault: false,
    pesoDefault: 2,
  ...
  },
  {
    ...
    corBadge: "bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300",
    incluirDefault: false,
    pesoDefault: 1,
    prioridadeDefault: "Baixa",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300",
    incluirDefault: true,
    pesoDefault: 2,
    prioridadeDefault: "Alta",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900 dark:text-cyan-300",
    incluirDefault: true,
    pesoDefault: 2,
    prioridadeDefault: "Alta",
    divisaoDefault: "A",
  ...
  },
  {
    ...
    corBadge: "bg-lime-100 text-lime-700 dark:bg-lime-900 dark:text-lime-300",
    incluirDefault: true,
    pesoDefault: 2,
    prioridadeDefault: "Alta",
    divisaoDefault: "A",
    topicos: [
      ...
      "Normas Brasileiras de Contabilidade — Auditoria Independente (NBC TA)",
      "Planejamento de auditoria e avaliação de riscos",
      "Risco de auditoria: inerente, controle e detecção",
      "Procedimentos de auditoria: natureza, extensão e oportunidade",
      "Evidências e papéis de trabalho em auditoria",
      "Auditoria do ativo e do passivo",
      "Relatório de auditoria independente: tipos de opinião e modificações",
      "Controle interno: avaliação e comunicação de deficiências",
      "Auditoria governamental: conceito e aplicações no setor público",
      "Fraudes e erros: responsabilidades do auditor e do administrador",
    ],
  },
  {
  ...
  },
  {
    ...
    corBadge: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300",
    incluirDefault: true,
    pesoDefault: 2,
    prioridadeDefault: "Alta",
    divisaoDefault: "B",
  ...
  },
  {
    ...
    corBadge: "bg-violet-100 text-violet-700 dark:bg-violet-900 dark:text-violet-300",
    incluirDefault: true,
    pesoDefault: 2,
    prioridadeDefault: "Alta",
    divisaoDefault: "C",
  ...
  },
  {
    ...
    corBadge: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900 dark:text-fuchsia-300",
    incluirDefault: true,
    pesoDefault: 2,
    prioridadeDefault: "Alta",
    divisaoDefault: "C",
