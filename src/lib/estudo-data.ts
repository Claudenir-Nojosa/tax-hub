...
export const MATERIAS: MateriaDef[] = [
  ...
  },
  {
    ...
    topicos: [
      ...
      "Procedimentos de auditoria; confirmações externas; testes de observância",
      "Estudo e avaliação do sistema contábil e de controles internos; testes substantivos",
      "Estimativas Contábeis",
      "Auditoria de estoque: interna, externa, sistemas e fluxo de mercadorias",
      "Papéis de trabalho e documentação de auditoria; evidência em auditoria",
      "Pareceres de auditoria",
      "NBC TA 230 (R1), 240 (R1), 265, 300 (R1), 315 (R2), 320 (R1), 500 (R1), 501, 505, 530, 540, 610, 620 e 700",
    ],
  },
  {
